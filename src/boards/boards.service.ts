...
export class BoardsService {
    ...
    // 2-1. service에서 repository를 사용할 수 있도록 injection 해준다. controller에서 service를 사용하기 위해 주입한 것과 동일!
    constructor(
        @InjectRepository(Board) // 인자로 repository가 아닌 entity를 넣어준다!!!!!!!
    ...
    // async createBoard(createBoardDto: CreateBoardDto) : Promise <Board> {
        ...
        // return board;
    // }
    // 2-6. DB 관련된 처리는 repository로 옮기자    
